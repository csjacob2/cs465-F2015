...
public class NotificationFreqDialog extends DialogFragment {
    ...
    public NotificationFreqDialog(Person person) {
        super();
        this.contact = person;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        np.setValue(options_lookup.get(contact.reminderFreq)); //Sets initial value to previously selected value
        //*******************************************************************************
        //******************************* Numpicker end *********************************
        //*******************************************************************************
        ...
        img.setImageResource(contact.image);
        ...
        builder//.setMessage(R.string.notify)
                .setPositiveButton(R.string.set, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        int val = np.getValue();
                        contact.reminderFreq = reminder_freq.get(options[val]);
                        System.out.println("Value: " + contact.reminderFreq);
                    }
                })
